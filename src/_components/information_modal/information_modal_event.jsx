...
export default function FullScreenInformationDialogEvent({event_id, headerName}) {
  ...
  useEffect(() => {
    dispatch(organizationActions.getAllEventInformation(event_id, setInformationObj))
  }, [updated]);
