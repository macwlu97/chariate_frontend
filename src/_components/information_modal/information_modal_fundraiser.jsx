...
export default function FullScreenInformationDialogFundraiser({fundraiser_id, headerName}) {
  ...
  useEffect(() => {
    dispatch(organizationActions.getAllFundraiserInformation(fundraiser_id, setInformationObj))
  }, [updated]);
