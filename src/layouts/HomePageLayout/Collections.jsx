          ...
          <React.Fragment>
            ...
            <Grid container spacing={4} direction="row">
              <Grid item xs={12} md={4}>
                <CardActionArea component="a" href="/popularity-organizations">
              ...
              <Grid item xs={12} md={4}>
                <CardActionArea component="a" href="/favorites-organizations">
                  <Card className={classes.card}>
                  <Hidden xsDown>
                    <CardMedia
                      className={classes.cardMedia}
              ...
              <Grid item xs={12} md={4}>
                <CardActionArea component="a" href="/growing-popularity-organizations">
                  <Card className={classes.card}>
                  <Hidden xsDown>
                    <CardMedia
                      className={classes.cardMedia}
              ...
              <Grid item xs={12} md={4}>
                <CardActionArea component="a" href="/last-added-organizations">
                  <Card className={classes.card}>
                  <Hidden xsDown>
                    <CardMedia
                      className={classes.cardMedia}
              ...
              <Grid item xs={12} md={4}>
                <CardActionArea component="a" href="/new-organizations">
                  <Card className={classes.card}>
                  <Hidden xsDown>
                    <CardMedia
                      className={classes.cardMedia}
